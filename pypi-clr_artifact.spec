...
Version  : 1.0.0
Release  : 1
URL      : https://github.com/clearlinux/clr-artifact/archive/refs/tags/v1.0.0.tar.gz
Source0  : https://github.com/clearlinux/clr-artifact/archive/refs/tags/v1.0.0.tar.gz
...
%prep
%setup -q -n clr-artifact-1.0.0
cd %{_builddir}/clr-artifact-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730854796
